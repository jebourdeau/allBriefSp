...
var nombre1 = prompt("1");
var nombre2 = prompt("2");
console.log(Number(nombre1) + Number(nombre2)); // erreur : il faut convertir les chaînes de caractères en nombres; rajouter la class Number, ou ParseInt (nombre1=parseInt)

// 2 - Réalisez une fonction "nombrePair" qui affiche dans la console les nombres pairs de 0 à 100.
function nombrePair() {
  for (var i = 0; i <= 100; i++) {
    if (i % 2 === 0) {
      console.log(i);//on passe de 2 == à 3 === valeur défini fix.
    }
  }
}
nombrePair();
...
console.log(nombre);// code manquant : il faut utiliser la fonction Math.floor() pour obtenir un nombre entier
